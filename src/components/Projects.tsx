        ...
        <div class="sticky top-24">
          ...
          <ul class="flex flex-wrap sm:flex-col gap-1.5">
            <For each={tags}>
              {(tag) => (
                <li>
                  <button onClick={() => toggleTag(tag)} class={cn("w-full px-2 py-1 rounded", "whitespace-nowrap overflow-hidden overflow-ellipsis", "flex gap-2 items-center", "bg-black/5 dark:bg-white/10", "hover:bg-custom-purp hover:dark:bg-custom-blue", "transition-colors duration-300 ease-in-out", filter().has(tag) && "text-black dark:text-white")}>
